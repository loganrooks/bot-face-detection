...
#add these here, should update json afterwards
KNOWN_DISTANCE = 30 # need original measurement #take pic of tennis ball from known width
KNOWN_WIDTH = 7 # width of a tennis ball
KNOWN_PIXEL_WIDTH = 50 # can be determined a priori
